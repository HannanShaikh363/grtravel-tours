...
class HotelBookingInvoiceMail extends Mailable
{
    ...
    public function envelope(): Envelope
    {
        $subject = $this->bookingData['booking_status'] === 'vouchered'
            ? ($this->bookingData['is_updated'] == 1 ? 'HOTEL PAYMENT RECEIPT UPDATED' : 'HOTEL PAYMENT RECEIPT')
            : ($this->bookingData['is_updated'] == 1 ? 'HOTEL BOOKING INVOICE UPDATED' : 'HOTEL BOOKING INVOICE/UNPAID');
    ...
    public function content(): Content
    {
        ...
        return new Content(
            view: 'email.hotel.hotel_invoice_email',
