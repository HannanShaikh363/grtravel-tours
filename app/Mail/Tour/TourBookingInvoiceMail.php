...
class TourBookingInvoiceMail extends Mailable
{
    ...
    public function envelope(): Envelope
    {
        $subject = $this->bookingData['booking_status'] === 'vouchered'
            ? ($this->bookingData['is_updated'] == 1 ? 'TOUR PAYMENT RECEIPT UPDATED' : 'TOUR BOOKING PAYMENT RECEIPT')
            : ($this->bookingData['is_updated'] == 1 ? 'TOUR BOOKING INVOICE UPDATED' : 'TOUR BOOKING INVOICE/UNPAID');
    ...
    public function content(): Content
    {
        ...
        return new Content(
            view: 'email.tour.tour_invoice_email',
