...
class TourBookingVoucherMail extends Mailable
{
    ...
    {
        $subject = $this->bookingData['is_updated'] ? 'TOUR BOOKING VOUCHER UPDATED' : 'TOUR BOOKING VOUCHER';
        return new Envelope(
            subject: $subject,
        );
    }
    ...
    public function content(): Content
    {
        ...
        return new Content(
            view: 'email.tour.tour_voucher_email',
