...
class HotelBookingInvoiceMail extends Mailable
{
    ...
    public function envelope(): Envelope
    {
        $subject = $this->bookingData['booking_status'] === 'vouchered'
            ? ($this->bookingData['is_updated'] == 1 ? 'CONTRACTUAL HOTEL PAYMENT RECEIPT UPDATED' : 'CONTRACTUAL HOTEL PAYMENT RECEIPT')
            : ($this->bookingData['is_updated'] == 1 ? 'CONTRACTUAL HOTEL BOOKING INVOICE UPDATED' : 'CONTRACTUAL HOTEL BOOKING INVOICE/UNPAID');
    ...
    public function content(): Content
    {
        ...
        return new Content(
            view: 'email.contractualhotel.hotel_invoice_email',
