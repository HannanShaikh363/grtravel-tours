...
class HotelBookingVoucherMail extends Mailable
{
    ...
    {
        $subject = $this->bookingData['is_updated'] ? 'CONTRACTUAL HOTEL BOOKING VOUCHER UPDATED' : 'CONTRACTUAL HOTEL BOOKING VOUCHER';
            return new Envelope(
    ...
    {
        return new Content(
            view: 'email.contractualhotel.hotel_voucher_email',
    ...
    public function attachments(): array
    {
        return [
            Attachment::fromPath($this->pdfFilePath) // Use the passed PDF file path
                ->as('ContractualBookingVoucher.pdf') // Name the attachment as 'booking.pdf'
